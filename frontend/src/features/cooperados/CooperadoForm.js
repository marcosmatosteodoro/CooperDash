...
const CooperadoForm = () => {
  ...
  useEffect(() => {
    setLayoutData(prev => ({
      ...
      buttons: (
        <Link className="btn btn-outline-secondary" to={isEdit ? `/cooperados/${id}` : '/cooperados'}>
